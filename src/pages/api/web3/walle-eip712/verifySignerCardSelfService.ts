...
const VerifySignerCardSelfServiceRequest = z.object({
...
const sampleReq: z.infer<typeof VerifySignerCardSelfServiceRequest> = {
    "chain": "mainnet",
    "operation": 0,
...
async function postProcessor(
    ...
    const request = VerifySignerCardSelfServiceRequest.parse(req.body);
